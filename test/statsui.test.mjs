...
import { ordinal, bucketIndex, barSpecs, buildTurnCard, buildGameCard } from '../public/js/statsui.js';
...
test('turn card: sample of one gets the set-the-bar line, no bars, no NaN', () => {
  ...
  assert.match(html, /FIRST BALL-1 ON RECORD/);
...
test('game card: first game ever gets the world-record line, no NaN', () => {
  const html = buildGameCard({
    finalScore: 300, sampleSize: 1, scorePercentile: 50,
